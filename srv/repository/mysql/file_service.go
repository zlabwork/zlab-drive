...
func (f *FileService) Get(id int64) (*app.File, error) {
...
func (f *FileService) GetByUUID(uuid string) (*app.File, error) {
...
func (f *FileService) Delete(id int64) error {
...
func (f *FileService) Create(file *app.File) (int64, error) {
...
func (f *FileService) Modify(file *app.File) error {
	return fmt.Errorf("TODO implement")
}

func (f *FileService) List(parent int64, offset int, size int) ([]*app.File, error) {
